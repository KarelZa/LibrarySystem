<?php
    ...
    $dir = "./uploads"; // Folder with uploaded bookcovers 
    $results_per_page = 5;
    ...
    // Function to convert Timestamp from db to ... xxx ago
...
<body class="allRecords">
    <div class="container text-light ">
        <div class="wrapper px-4 py-4 ">
            ...
            <?php 
            endwhile;
            mysqli_free_result($result); // Free result as they are not needed anymore
