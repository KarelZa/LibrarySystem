<?php 
	...
	require 'details.php';
	if (!($con = mysqli_connect($server,$username,$password,$db))) {  // Pripojeni na mysql do db, pri uspechu $con <> 0
		die("Nelze se připojit k databázovému serveru!"); // Error hlaska pokud $con == 0;
	}
